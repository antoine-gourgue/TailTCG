  ...
  const [{ data: items }, { data: sources }, { data: binders }, { data: gradings }] =
    await Promise.all([
      supabase
        ...
        .select(
          "id, tcgdex_id, card_name, set_name, set_id, local_id, image_url, card_type, rarity, language, condition, quantity, purchase_price, purchase_date, manual_price, source_id, graded, grade, created_at, current_price, gain, sold_price, sold_at, needs_review"
        )
